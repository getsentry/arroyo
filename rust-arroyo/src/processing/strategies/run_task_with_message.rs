...
pub struct RunTaskWithMessage<TPayload, TTransformed> {
...
impl<TPayload, TTransformed> RunTaskWithMessage<TPayload, TTransformed> {
...
impl<TPayload, TTransformed: Send + Sync> ProcessingStrategy<TPayload>
    for RunTaskWithMessage<TPayload, TTransformed>
{
...
mod tests {
    ...
    fn test_run_task() {
        ...
        let mut strategy = RunTaskWithMessage::new(identity, Noop {});
